...
export default {
  origTrails: [
    ...
    },
    {
      ...
      summary:
        "This pleasant loop is a scenic alternative for those wishing to avoid more crowded parks.",
      difficulty: "greenBlue",
      imgSmall: img3,
      length: 2.9,
      longitude: -79.0541,
    ...
    },
    {
      ...
      summary:
        "This trail passes through woodlands to reach the Jordan Lake shoreline and loops back through woodlands.",
      difficulty: "greenBlue",
      imgSmall: img9,
      length: 5.1,
      longitude: -79.048,
    ...
    },
    {
      ...
      name: "Lake Trail",
      summary:
        "The Lake Trail is a great urban escape and one of the best in the Triangle area!",
      difficulty: "blue",
      imgSmall: img12,
      length: 6.4,
      longitude: -78.7954,
    ...
    },
    {
      ...
      summary:
        "An easy, short loop hike around the lake on singletrack, mulched, and paved trail.",
      difficulty: "blue",
      imgSmall: img14,
      length: 3,
      longitude: -78.8293,
    ...
    },
    {
      ...
      summary:
        "A good rolling loop trail through established NC forest with water features.",
      difficulty: "greenBlue",
      imgSmall: img16,
      length: 5.4,
      longitude: -78.7251,
    ...
    },
    {
      ...
      summary:
        "A hike with everything: dramatic views from atop bluffs, scenic rivers, and unique ecosystems.",
      difficulty: "greenBlue",
      imgSmall: img20,
      length: 2.4,
      longitude: -79.1607,
